  ...
  if (toolKind === 'execute') {
    ...
    return {
      ...
      options: [
        ...
        { label: 'No, and tell LX-AICODING what to do differently', decision: 'reject' },
      ],
    };
  }
        ...
        {hasPendingApproval && approvalContent ? (
          ...
          <>
            <textarea
              ...
              placeholder={busy ? "Send a message to queue next..." : "Ask LX-AICODING anything, @ to add files, / for commands"}
