...
const TRIGGER_MODES: Array<{ value: TriggerMode; label: string; description: string }> = [
  ...
  },
  {
    value: "manual",
    label: "Manual Only",
    description: "Only review when the configured review command is commented",
  },
];
...
function ReviewPage() {
  ...
  const triggerDescription =
    ...
    "PR Review will automatically review every push to a PR";
      ...
      <SettingsSection title="Configuration">
        <div className="divide-y divide-border">
          ...
          <SettingsRow
            ...
            description="Org-wide default for whether PR Review runs on draft PRs. Each user can override this in Profile Settings."
            control={
              <Switch
      ...
      <div className="divide-y divide-border">
        ...
        {!loading && grouped.length === 0 && (
          <p className="px-4 py-3 text-xs text-muted-foreground">
            No repository integrations found. Configure Gitee/GitHub access for an
