...
function GlobalDefaultsSection({ models }: { models: Array<ModelOption> }) {
  ...
  return (
    <SettingsSection
      ...
      description="Workspace-wide model defaults. Per-user LX-AICODING selections override the agent defaults."
    >
      <div className="divide-y divide-border">
        <RolePicker
          label="LX-AICODING 智能体"
          description="Model used for internal code-writing runs triggered from the dashboard or integrations."
          models={models}
        ...
        <SettingsRow
          ...
          description="Global fallback used when a run has no explicit repo and the user has no profile default. Gitee URLs and owner/repo are supported."
          control={
            <Input
              className="w-56"
