...
function CloudAgentsPage() {
  ...
  return (
    <AppShell
      user={session.data}
      title="LX-AICODING 智能体"
      description="Configure how LX-AICODING picks a model, Gitee repository, and PR defaults."
    >
      <SettingsSection title="Defaults">
        <div className="divide-y divide-border">
          ...
          <SettingsRow
            ...
            description="Used when no repository is specified. Gitee URLs and owner/repo are supported."
            control={
              repos.data?.repositories?.length ? (
                <div className="w-56">
                  <RepoSelector
                    ...
                    placeholder="Pick or enter a repository"
          ...
          <SettingsRow
            label="Base Branch"
            description="When empty, the agent will use the repository's default branch."
            htmlFor="base-branch"
            control={
              <Input
                id="base-branch"
